...
public class UserControllerIntegrationTest {
        ...
        public void testRegisterUser_whenValidUserDetailsProvided_shouldCreateUserAndReturnUserInformation()
                ...
                UserRegisterDto registerUserDto = new UserRegisterDto(testUser.getUsername(), testUser.getPassword(),
                                testUser.getEmail());
        ...
        @Test
        @Order(2)
        public void testAuthenticateUser_whenCorrectUserCredentialsProvided_shouldAuthenticateAndReturnJWT()
                        throws Exception {
        ...
        @Test
        @Order(5)
        public void testAuthenticateAdmin_whenUserProvidesValidAdminCredentials_shouldReceiveCorrectlyFormatedJWT()
                        throws Exception {

                // first get jwt for admin
                LoginRequestDto loginRequestDto = new LoginRequestDto(testAdmin.getUsername(),
                                this.testAdmin.getPassword());
                String loginRequestDtoJson = objectMapper.writeValueAsString(loginRequestDto);
        ...
        public void testUpdateUser_whenProvidedValidNewUserDetails_shouldUpdateUserInDb() throws Exception {
                ...
                UserUpdateRequestDto newUserDataDto = new UserUpdateRequestDto("new_" + testUser.getUsername(),
                                "new_" + testUser.getEmail(), "new_" + testUser.getPassword());
