...
public class QuizController {
    ...
    @PreAuthorize("#userId == principal.claims['sub'] or hasAuthority('ADMIN')")
    ...
    @PreAuthorize("#quizCreateDto.userId == principal.claims['sub'] or hasAuthority('ADMIN')")
    ...
    @PreAuthorize("#quizUpdateDto.userId == principal.claims['sub'] or hasAuthority('ADMIN')")
    ...
    @PreAuthorize("#quizDeleteRequestDto.userId == principal.claims['sub'] or hasAuthority('ADMIN')")
