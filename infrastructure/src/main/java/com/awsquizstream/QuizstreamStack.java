...
public class QuizstreamStack extends Stack {
    ...
    public QuizstreamStack(final Construct scope, final String id, final StackProps props) {
        ...
        RDSStack rdsStack = new RDSStack(this, "Rds", nestedStackProps, vpcStack.getVpc(), bastionStack.getBastionSg());
        ...
        AngularCodePipelineStack angularCodePipelineStack = new AngularCodePipelineStack(this, "FrontendPipeline",
                nestedStackProps,
                ecsFargateStack.getFrontendService());

        // create Backend CodePipeline
        BackendCodePipelineStack backendCodePipelineStack = new BackendCodePipelineStack(this, "BackendPipeline",
                nestedStackProps,
